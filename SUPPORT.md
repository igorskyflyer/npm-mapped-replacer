...
Hello, thank you for using Mapped Replacer! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-mapped-replacer/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-mapped-replacer/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-mapped-replacer/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Mapped Replacer version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-mapped-replacer/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-mapped-replacer/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Mapped Replacer:
...
<div align="center">
  Thank you for using Mapped Replacer!
  <br>
